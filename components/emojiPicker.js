class EmojiPicker extends HTMLElement {
        ...
        this.shadowRoot.innerHTML = `
            <style>
                :host {
                    ...
                    height: 45vh; /* Reduced to 45% */
                    max-height: 45vh; /* Reduced to 45% */
                    width: 100%;
    ...
    loadEmojis(filter) {
        ...
        // Ensure the order of unshifting reflects how you want them to appear (last unshifted is at the TOP).
        // Desired order from top to bottom: 
        // 1. Recents
        // 2. Chat Vibe (Chatmood)
        // 3. Smart AI (Suggested)
        // 4. Related
        
        // 4. Insert "Related" Row Context based on very last click
        ...
        // 3. Insert Suggestions AI if we have data (Now strictly 1 line, up to 8 emojis)
        ...
        // 1. Insert Recents (limit to 8 handled in addToRecents/constructor so it stays as 1 row)
