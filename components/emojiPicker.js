...
        
        // Load recents and limit to 8 (1 line of 8)
        let savedRecents = JSON.parse(localStorage.getItem('goorac_recents')) || [];
        this.recentEmojis = savedRecents.slice(0, 8);
        
...
                {c:'🫁', k:'lungs breathe air organ'}, {c:'🦷', k:'tooth dentist bite'}, {c:'🦴', k:'bone dog skeleton structure'}, {c:'👀', k:'eyes look stare see watch drama tea'}, {c:'👁️', k:'eye illuminati vision'}, {c:'👅', k:'tongue lick taste'}, {c:'👄', k:'mouth lips kiss speak'},
                {c:'🫨', k:'shaking face shock blur dizzy wtf'}, {c:'🫠', k:'melting face hot sad disappear anxiety'}, {c:'🥲', k:'smiling tear sad proud hold back'}, {c:'🥹', k:'pleading holding back tears happy tears'}, {c:'🫡', k:'salute respect yes sir soldier'}
            ]},
...
                {c:'🗣️', k:'speaking talking shout profile yell'}, {c:'👤', k:'silhouette shadow user account profile'}, {c:'👥', k:'silhouettes users group team friends'}, {c:'🫂', k:'hug embrace support love care comfort'}, {c:'🫸', k:'rightward pushing hand high five push stop'}, {c:'🫷', k:'leftward pushing hand high five push stop'}
            ]},
...
                {c:'☄️', k:'comet space rock fly fire tail crash star meteor burn'}, {c:'🔥', k:'fire flame hot lit fire burn blaze heat warmth danger'}, {c:'🌊', k:'wave ocean sea surf water beach tide blue splash tsunami'}, {c:'💧', k:'droplet water tear wet rain drop cry sweat blue liquid'},
                {c:'🪿', k:'goose bird animal honk feather'}, {c:'🪼', k:'jellyfish sea ocean sting underwater'}, {c:'🪻', k:'hyacinth flower plant purple spring'}, {c:'🪽', k:'wing fly angel bird animal feather'}
            ]},
...
                {c:'🍻', k:'beers clink cheers alcohol pub bar toast celebrate party mugs foam glass'}, {c:'🥂', k:'clinking glasses cheers celebrate toast champagne wine party alcohol tall stem'}, {c:'🥃', k:'whiskey glass shot alcohol liquor brown rock ice sip bar pour strong'}, {c:'🥤', k:'cup straw soda drink fast food plastic lid red cold pop beverage sip'}, {c:'🧃', k:'juice box drink apple kid straw fruit sweet pack liquid squeeze lunch'}, {c:'🧉', k:'mate drink tea herb gourd straw south america green leaf brew sip warm'}, {c:'🧊', k:'ice cube cold freeze water square block freeze clear chill melt drink'},
                {c:'🫛', k:'peapod green vegetable food plant nature'}, {c:'🫚', k:'ginger root spice cook food flavor tea'}
            ]},
...
                {c:'⤵️', k:'curv down arrow point direction drop sink fall dip arc drop scoop swing'}, {c:'🔀', k:'shuffle media arrows mix swap random twist interlace thread twine media'}, {c:'🔁', k:'repeat media arrows cycle round loop round sync again replay refresh renew'}, {c:'🔂', k:'repeat one media arrows cycle round loop one track single replay loop solo'},
                {c:'🩷', k:'pink heart love cute sweet pink'}, {c:'🩵', k:'light blue heart sky ocean calm'}, {c:'🩶', k:'grey heart neutral silver sad'}
            ]},
...
                    height: var(--emoji-keyboard-height, 45%); /* Changed from 320px to 45% */
                    max-height: 45vh; /* Changed from 50vh to 45vh */
                    width: 100%;
...
            },
            tamil: {
                happy: ['santhosham', 'magilchi', 'super', 'sema', 'nalla', 'nandri', 'சந்தோஷம்', 'மகிழ்ச்சி', 'நன்று', 'mass', 'verithanam', 'arputham', 'pramatham', 'jolly'],
                sad: ['kavalai', 'varutham', 'sogam', 'kavala', 'kashtam', 'vali', 'கவலை', 'வருத்தம்', 'சோகம்', 'paavam', 'kaneer', 'azhugai'],
                angry: ['kovam', 'kaduppu', 'erichal', 'poda', 'loosu', 'mutal', 'கோபம்', 'கடுப்பு', 'எரிச்சல்', 'eruma', 'paithiyam', 'tension'],
                love: ['kadhal', 'anbu', 'chellam', 'kutti', 'pondatti', 'purushan', 'uyire', 'காதல்', 'அன்பு', 'செல்லம்', 'thangam', 'kannu', 'azhage', 'kadhali'],
                funny: ['sirippu', 'nagaichuvai', 'கலக்கல்', 'சிரிப்பு', 'siripa', 'comedy', 'mokkai'],
                surprised: ['achariyam', 'athirchi', 'enna', 'nijamava', 'ஆச்சரியம்', 'அதிர்ச்சி', 'appadiya', 'unmaiyava', 'pababa', 'goyyale']
            },
            english: {
                happy: ['good', 'great', 'happy', 'yay', 'awesome', 'nice', 'sweet', 'cool', 'amazing', 'best', 'fantastic', 'fabulous', 'wonderful', 'excellent'],
                sad: ['sad', 'bad', 'sorry', 'depressed', 'down', 'miss', 'cry', 'hurt', 'pain', 'terrible', 'awful', 'tragic'],
                angry: ['angry', 'mad', 'hate', 'annoyed', 'wtf', 'stupid', 'dumb', 'idiot', 'furious', 'pissed', 'enraged'],
                love: ['love', 'miss you', 'babe', 'baby', 'kiss', 'heart', 'beautiful', 'cute', 'darling', 'sweetheart', 'gorgeous'],
                funny: ['haha', 'lmao', 'lol', 'rofl', 'dead', 'funny', 'joke', 'hilarious', 'silly', 'humor', 'comical'],
                surprised: ['wow', 'omg', 'really', 'shocked', 'whoa', 'crazy', 'insane', 'unbelievable', 'astonished']
            }
        };
...
        // Insert Recents (limit to 8 handled in addToRecents/constructor)
...
        // Recents array manipulation - limited to 8
        this.recentEmojis = this.recentEmojis.filter(e => e !== char);
        this.recentEmojis.unshift(char);
        if(this.recentEmojis.length > 8) this.recentEmojis.pop(); // Max 1 line (8 columns x 1)
